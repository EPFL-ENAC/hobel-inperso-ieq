...
🔄 Continuous integration using [Github Actions](https://github.com/EPFL-ENAC/hobel-inperso-ieq/blob/main/.github/workflows) with jobs to check the quality of your code.
